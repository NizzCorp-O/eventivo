...
import 'package:eventivo/features/Events/Presentation/screens/admin_dashbord.dart/scanned_tickets.dart';
  ...
  void _onDetect(BarcodeCapture capture) async {
    ...
    Future.delayed(const Duration(seconds: 1), () {
      ...
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (context) => const ScannedTickets()),
